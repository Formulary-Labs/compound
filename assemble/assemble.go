...
func writeClause7(sb *strings.Builder, cfg DocumentConfig, _ *ProgramContext, orgName string) {
...
func AssembleDelta(cfg DocumentConfig, curr, prev *ProgramContext) string { //nolint:revive // stutter is intentional
	if curr == nil {
...
func AssembleSection(cfg DocumentConfig, ctx *ProgramContext) (string, error) { //nolint:revive // stutter is intentional
	if ctx == nil {
		ctx = &ProgramContext{Program: cfg.Program}
	}
